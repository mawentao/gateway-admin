define(function(require){
    ...
    o.init = function(domid){
        ...
        grid = new MWT.Grid({
            ...
            cm: new MWT.Grid.ColumnModel([
                ...
                {head:'后端服务环境',dataIndex:'id',width:100,align:'center',sort:true,render:function(v,item){
                    return '<button name="envbtn-'+gridid+'" data-id="'+v+'" '+
								'class="mwt-btn mwt-btn-primary mwt-btn-sm radius">详情</button>';
                }},
        ...
        store.on('load',function(){
            mwt.popinit();
			// 后端服务环境按钮
			jQuery('[name=envbtn-'+gridid+']').unbind('click').click(function(){
                var id = jQuery(this).data('id');
				var item = grid.getRecord('id',id);
				require('./appenv/page').open(item);
			});
            // 编辑按钮
