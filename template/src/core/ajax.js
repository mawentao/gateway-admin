define(function(require){
    ...
    o.getJavaAjaxUrl = function(api) {
        return dz.javaapi+api;
    };
	...
	// POST方式提交java Ajax请求
    o.postjava = function(cachekey,params,callbackfun,sync){
        var url=o.getJavaAjaxUrl(cachekey);
        o.ajaxrequest("post", url, params, callbackfun, sync);
    }


    // POST方式提交java Ajax请求
    o.postjava2 = function(cachekey,params,callbackfun,sync){
        var url=o.getJavaAjaxUrl(cachekey);
        o.ajaxrequest("post", url, params, callbackfun, sync);
    }

    // GET方式提交Ajax请求
    o.get = function(cachekey, params, callbackfun, sync) {
        var url = o.getAjaxUrl(cachekey);
        o.ajaxrequest("get", url, params, callbackfun, sync);
    };

    o.getjava = function(cachekey, params, callbackfun, sync) {
        var url = o.getJavaAjaxUrl(cachekey);
        o.ajaxrequest("get", url, params, callbackfun, sync);
    };
